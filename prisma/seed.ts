...
const commissionRules: SeedRule[] = [
  ...
  // === Electronics L1 代表费率 (多数子类目 5.40% 系列) ===
  { feeType: FeeType.COMMISSION, category: "Electronics", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.BXP, rate: 0.0540, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Electronics L1 代表费率" },
  { feeType: FeeType.COMMISSION, category: "Electronics", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.NON_BXP, rate: 0.0972, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Electronics L1 代表费率" },
  { feeType: FeeType.COMMISSION, category: "Electronics", shopType: ShopType.MALL, bxpStatus: BxpStatus.BXP, rate: 0.0864, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Electronics L1 代表费率" },
  { feeType: FeeType.COMMISSION, category: "Electronics", shopType: ShopType.MALL, bxpStatus: BxpStatus.NON_BXP, rate: 0.1296, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Electronics L1 代表费率" },

  // === Electronics L2 子类目（费率与 L1 代表值不同的关键子类目） ===
  // Phones & Electronics: Phones/Tablets/Cameras/Gaming/Smart Devices (5.40% 系列，同 L1)
  { feeType: FeeType.COMMISSION, category: "Electronics > Phones & Electronics", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.BXP, rate: 0.0540, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phones/Tablets/Cameras/Gaming" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Phones & Electronics", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.NON_BXP, rate: 0.0972, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phones/Tablets/Cameras/Gaming" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Phones & Electronics", shopType: ShopType.MALL, bxpStatus: BxpStatus.BXP, rate: 0.0864, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phones/Tablets/Cameras/Gaming" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Phones & Electronics", shopType: ShopType.MALL, bxpStatus: BxpStatus.NON_BXP, rate: 0.1296, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phones/Tablets/Cameras/Gaming" },
  // Phone Accessories & Universal (7.02% 系列)
  { feeType: FeeType.COMMISSION, category: "Electronics > Phone Accessories", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.BXP, rate: 0.0702, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phone Accessories/Universal" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Phone Accessories", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.NON_BXP, rate: 0.1134, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phone Accessories/Universal" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Phone Accessories", shopType: ShopType.MALL, bxpStatus: BxpStatus.BXP, rate: 0.1026, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phone Accessories/Universal" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Phone Accessories", shopType: ShopType.MALL, bxpStatus: BxpStatus.NON_BXP, rate: 0.1458, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Phone Accessories/Universal" },
  // Computers & Office (Computer Components/Peripherals/Audio: 8.10% 系列)
  { feeType: FeeType.COMMISSION, category: "Electronics > Computers & Office", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.BXP, rate: 0.0810, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Computer Components/Peripherals" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Computers & Office", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.NON_BXP, rate: 0.1242, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Computer Components/Peripherals" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Computers & Office", shopType: ShopType.MALL, bxpStatus: BxpStatus.BXP, rate: 0.1134, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Computer Components/Peripherals" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Computers & Office", shopType: ShopType.MALL, bxpStatus: BxpStatus.NON_BXP, rate: 0.1566, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Computer Components/Peripherals" },
  // Automotive & Motorcycle (7.02% 系列)
  { feeType: FeeType.COMMISSION, category: "Electronics > Automotive & Motorcycle", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.BXP, rate: 0.0702, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Car Electronics" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Automotive & Motorcycle", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.NON_BXP, rate: 0.1134, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Car Electronics" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Automotive & Motorcycle", shopType: ShopType.MALL, bxpStatus: BxpStatus.BXP, rate: 0.1026, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Car Electronics" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Automotive & Motorcycle", shopType: ShopType.MALL, bxpStatus: BxpStatus.NON_BXP, rate: 0.1458, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Car Electronics" },
  // Household Appliances (5.40% 系列)
  { feeType: FeeType.COMMISSION, category: "Electronics > Household Appliances", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.BXP, rate: 0.0540, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Home/Kitchen Appliances" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Household Appliances", shopType: ShopType.MARKETPLACE, bxpStatus: BxpStatus.NON_BXP, rate: 0.0972, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Home/Kitchen Appliances" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Household Appliances", shopType: ShopType.MALL, bxpStatus: BxpStatus.BXP, rate: 0.0864, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Home/Kitchen Appliances" },
  { feeType: FeeType.COMMISSION, category: "Electronics > Household Appliances", shopType: ShopType.MALL, bxpStatus: BxpStatus.NON_BXP, rate: 0.1296, fixedAmount: null, perUnit: FeeUnit.REVENUE, source: SOURCE.commission, effectiveFrom: COMMISSION_EFFECTIVE, note: "v2: Home/Kitchen Appliances" },
